...
class Stats:
    def __init__(self, screen):
        ...
        self._results = result_service.get_results()
        self._stats = result_service.get_stats()
        self._back_button = Button("BACK", (10, 10), 30, outline_width=3)
    ...
    def draw_stats(self):
        ...
        stats_texts = [
            f"Total games: {self._stats['total_games']}",
    ...
    def button_is_clicked(self, mouse_pos: tuple) -> str | None:
        if self._back_button.is_clicked(mouse_pos):
            return "back"
        return None
